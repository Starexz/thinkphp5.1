...
class loaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('app\index\controller\User', Loader::parseClass('Home', 'Controller', 'user'));
        $this->assertEquals('app\index\controller\user\Type', Loader::parseClass('Home', 'Controller', 'user.type'));
