...
class requestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = Request::create('http://www.thinkphp.cn/Home/Home/hello.html?name=thinkphp');
        $this->assertEquals('http://www.thinkphp.cn', $request->domain());
        $this->assertEquals('/Home/Home/hello.html?name=thinkphp', $request->url());
        $this->assertEquals('/Home/Home/hello.html', $request->baseurl());
        $this->assertEquals('Home/Home/hello.html', $request->pathinfo());
        $this->assertEquals('Home/Home/hello', $request->path());
    ...
    {
        $request = Request::instance();
        $request->url('/Home.php/Home/hello?name=thinkphp');
        $this->assertEquals('/Home.php/Home/hello?name=thinkphp', $request->url());
        $this->assertEquals('http://thinkphp.cn/Home.php/Home/hello?name=thinkphp', $request->url(true));
    }

    public function testBaseUrl()
    {
        $request = Request::instance();
        $request->baseurl('/Home.php/Home/hello');
        $this->assertEquals('/Home.php/Home/hello', $request->baseurl());
        $this->assertEquals('http://thinkphp.cn/Home.php/Home/hello', $request->baseurl(true));
    }
    ...
    public function testbaseFile()
    {
        ...
        $this->assertEquals('/Home.php', $request->basefile());
        $this->assertEquals('http://thinkphp.cn/Home.php', $request->basefile(true));
    }
    ...
    public function testroot()
    {
        ...
        $this->assertEquals('/Home.php', $request->root());
        $this->assertEquals('http://thinkphp.cn/Home.php', $request->root(true));
    }
